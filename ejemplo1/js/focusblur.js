...
function registrarEscuchas(objeto, numeroMensaje) {
  ...
  objeto.addEventListener(
    ...
    function () {
      ...
      console.log(numeroMensaje + " Odio esto");
  ...
  objeto.addEventListener(
    ...
    function () {
      ...
      console.log(numeroMensaje + " Amo esto");
    },
    false
  );
  objeto.addEventListener(
    ...
    function () { 
      ...
      var inputNombre = formulario.elements["nombre"];
    
      // Verifica si el valor del input es igual a "Noel"
      if (inputNombre.value === "Noel") {
          document.write("¡Cómo sabes eso?");
      }
    });
  console.log(objeto);
  console.log(numeroMensaje);
